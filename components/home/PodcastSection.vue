...
<template>
  <section class="mt-[10vh] wrapper">
    ...
    <div
      class="col-span-full mt-[-1vw]"
      data-scroll
      data-scroll-speed="-2"
      data-scroll-speed-mobile="-0.5"
      data-scroll-start="top 100%"
    >
      <div id="marquee-pod-images" class="flex">
        <img
          class="w-[30vw]"
          v-for="({ src, style }, i) in podcastThumbnails"
          :src="src"
          :key="i + src"
          alt=""
          :class="style"
    ...
    <p
      id="pod-desc"
      class="col-start-2 md:col-start-6 col-end-15 md:col-end-19"
    >
      ...
      we’ve featured some of the leading voices in Christian philosophy,
    ...
    <div class="row-start-5 wrapper mt-[6vw] md:mt-[12vw]">
      ...
      <img
        class="col-start-6 row-start-2 md:col-span-12 md:row-start-1 col-end-16 md:col-start-17"
        data-scroll
        data-scroll-speed="-2"
        data-scroll-speed-mobile="-0.5"
        data-scroll-start="top 100%"
    ...
    <div class="row-start-6 wrapper mt-[6vw]">
      <h2
        id="all-platforms"
        class="col-start-2 row-start-1 text-left md:col-span-5 md:col-start-4 col-end-15"
      >
      ...
      <a
        class="col-span-9 col-start-6 row-start-6 md:col-span-4 md:col-start-17"
